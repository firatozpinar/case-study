...
<template>
    <div class="app">
            ...
            <div class="fixed-container">
                <div class="wrp">
                    <div class="logo" @click="$router.push('/')">
                        <svg class="navbar-logo" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" width="162" height="24" viewBox="0 0 162 24">
                            <defs>
                                <path id="a"
        ...
        <main class="main">
            <div class="fixed-container">
                <div class="wrp">
                    <vue-page-transition name="fade" class="fluid">
                        <router-view />
                    </vue-page-transition>
                </div>
            </div>
        ...
        <footer class="footer">
            <div class="fixed-container">
                © 2008 - 2020 Tüm hakları saklıdır. Enuygun.com
            </div>
        </footer>
    </div>
</template>
